...
class afterresetstudent extends StatefulWidget {
  String value;
  afterresetstudent({super.key, required this.value});

  @override
  State<afterresetstudent> createState() => _afterresetstudentState();
}

class _afterresetstudentState extends State<afterresetstudent> {
  @override
