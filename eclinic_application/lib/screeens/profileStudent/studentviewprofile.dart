                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      ...
                                      BlocGroupSelect.get(context).selectGroup(
                                          BlocProfileStudent.get(context)
                                              .currentGroup);
                                      /*
                                    ...
                                    children: [
                                      Expanded(
                                        ...
                                        child: DropdownButtonFormField(
                                          value: BlocProfileStudent.get(context)
                                              .currentGroup
                                              ?.Projectcompletiondate
                                              ?.convertToWordMonth()
                                              .toString(),
                                      ...
                                      Expanded(
                                        ...
                                        child: DropdownButtonFormField<String>(
                                          ...
                                          items:
                                              years.map((String dropdownitems) {
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            if (formkey.currentState!.validate()) {
                              GPdate = (selctedyear == null || month == null)
                                  ? null
                                  : dategp(selctedyear, month?.toString());
                              //print(selctedyear) ;
                              //print(month) ;
                              //print(GPdate) ;
                              ModelGroup modelGroupChangedField = ModelGroup(
                                  department: BlocProfileStudent.get(context)
                                      .currentGroup!
                                      .department,
                                  projectname: _groupName.value.text,
                                  students: BlocProfileStudent.get(context)
                                      .currentGroup!
                                      .students,
                                  uploadgp: BlocProfileStudent.get(context)
                                      .currentGroup!
                                      .uploadgp,
                              ...
                              if (modelGroupChangedField.projectname !=
                                ...
                                if (await BlocProfileStudent.get(context)
                                    .checkIfNameGroupExist(
                                        modelGroupChangedField.projectname)) {
                              ...
                              showInSnackBar(context, 'pleas check fields !',
                                  onError: true);
                            }
                          },
