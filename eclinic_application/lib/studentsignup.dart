...
class _studentsignupState extends State<studentsignup> {
  ...
  checkidcategory(List<String?> specialityoption) async {
    category.length = 0;
        ...
        querySnapshot.docs.forEach((element) {
          setState(() {
            for (var i = 0; i < specialityoption.length; i++) {
              if (element['gpcategoryname'] == specialityoption[i]) {
                ...
                child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //         } else {
                        //           if (!(english.hasMatch(_idController.text))) {
                        //             return "only english is allowed";
                        //           }
                        //         }
                        //       }
                        ...
                        TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                hintText: "Enter your Graduation project title",
                                border: OutlineInputBorder()),
                            autovalidateMode:
                                AutovalidateMode.onUserInteraction,
                            validator: (value) {
                              if (value!.isEmpty || _projecttitle.text == "") {
